...
function Header() {
  const options = [
    { value: 'uz', label: (<div className='option'><img className='option-img' src={uzImg} alt="Img error" /> <p>O'zbekcha</p></div>) },
    { value: 'ru', label: (<div className='option'><img className='option-img' src={ruImg} alt="Img error" /> <p>Русский</p></div>) },
    { value: 'en', label: (<div className='option'><img className='option-img' src={engImg} alt="Img error" /> <p>English</p></div>) }
  ]
  return (
    <header className='header'>
      <div className='container'>
        <div className='header-top'>
          ...
          <Select className='header-selectReact' placeholder='Tilni tanlang' options={options} />
        </div>
